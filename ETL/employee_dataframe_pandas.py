...
employeeJobFamily = jobFamily[jobFamilyCols].toPandas()
# employeeJobFamily.head()

# COMMAND ----------

employeeJobs = employeeJobs.merge(employeeJobFamily, on='jobProfileId', how='left').drop(["jobProfileId"], axis=1)
# employeeJobs.head()
